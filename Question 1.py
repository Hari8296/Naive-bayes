...
salary_test = pd.read_csv("D:/assignments of data science/Master class/07 Naive bayes/SalaryData_Test.csv",encoding = "ISO-8859-1")
salary_train = pd.read_csv("D:/assignments of data science/Master class/07 Naive bayes/SalaryData_Train.csv",encoding = "ISO-8859-1")
...
with open("D:/assignments of data science/Text mmining sentiment analysis/Stopwords_en.txt","r") as sw:
    stop_words = sw.read()
